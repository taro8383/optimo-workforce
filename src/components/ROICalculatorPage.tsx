...
const ROICalculatorPage: React.FC = () => {
  ...
  const regions = [
    { value: 'US', label: 'United States', savings: 23 },
    { value: 'EU', label: 'European Union', savings: 20 },
    { value: 'LATAM', label: 'Latin America', savings: 25 },
    { value: 'APAC', label: 'Asia-Pacific', savings: 22 }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl lg:text-2xl mb-8 text-blue-100 max-w-4xl mx-auto">
              Calculate your potential savings with AI-powered workforce optimization. See exactly how much you could save in labor costs, scheduling time, and turnover reduction.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <div className="space-y-6">
                ...
                >
                  {regions.map((region) => (
                    <option key={region.value} value={region.value}>
                      {region.label} ({region.savings}% avg savings)
                    </option>
                  ))}
                </select>
              </div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-3">
                  Cost to Hire & Train New Employee ($)
                </label>
                <input
                  type="number"
                  min="500"
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-primary to-blue-600 rounded-2xl p-8 text-white">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white bg-opacity-20 rounded-lg p-4">
                  ...
                  <div className="text-sm opacity-90">Total Annual Savings</div>
                </div>
                <div className="bg-white bg-opacity-20 rounded-lg p-4">
                  <div className="text-3xl font-bold mb-2">
                ...
                <div className="bg-white bg-opacity-20 rounded-lg p-4">
                  <div className="text-3xl font-bold mb-2">
                    {formatNumber(results.monthlyROI)}%
                  </div>
                ...
                <div className="bg-white bg-opacity-20 rounded-lg p-4">
                  ...
                  <div className="text-sm opacity-90">5-Year Net Savings</div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-secondary pl-6">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-lg font-semibold text-gray-900">Labor Cost Optimization</h4>
                    <span className="text-2xl font-bold text-secondary">
                      {formatCurrency(results.annualSavings)}
                    </span>
                  </div>
                  <p className="text-gray-600 mb-3">
                    AI-powered scheduling reduces overstaffing and optimizes shift patterns
                  </p>
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="flex justify-between text-sm">
                      <span>Optimized Annual Labor Cost:</span>
                ...
                <div className="border-l-4 border-primary pl-6">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-lg font-semibold text-gray-900">Scheduling Time Savings</h4>
                    <span className="text-2xl font-bold text-primary">
                      {formatCurrency(results.schedulingCostSavings)}
                    </span>
                  </div>
                  <p className="text-gray-600 mb-3">
                    Reduce scheduling time by 78% with one-click AI optimization
                  </p>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex justify-between text-sm">
                      <span>Time Saved per Week:</span>
                      <span className="font-semibold">{formatNumber(results.schedulingTimeSavings)} hours</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span>Manager Rate:</span>
                ...
                <div className="border-l-4 border-accent-latam pl-6">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-lg font-semibold text-gray-900">Turnover Reduction</h4>
                    <span className="text-2xl font-bold text-accent-latam">
                      {formatCurrency(results.turnoverSavings)}
                    </span>
                  </div>
                  <p className="text-gray-600 mb-3">
                    Better scheduling improves employee satisfaction and reduces turnover by 43%
                  </p>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex justify-between text-sm">
                      <span>Current Turnover Rate:</span>
                      <span className="font-semibold">{formData.turnoverRate}%</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span>Optimized Turnover Rate:</span>
                      <span className="font-semibold">{formatNumber(formData.turnoverRate * 0.57)}%</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Action Buttons */}
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Get Your Detailed Report</h3>
              <div className="space-y-4">
                ...
                <button className="w-full bg-secondary hover:bg-green-600 text-white py-4 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-3">
                  <Target size={24} />
                  Schedule Demo to Validate Results
                </button>
        ...
        <div className="mt-16 bg-white rounded-2xl p-8 shadow-lg">
          <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">
            Industry Benchmarks vs. Optimo Results
          </h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Staff Turnover</h4>
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">With Optimo:</span>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Scheduling Time</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-600">Industry Average:</span>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Labor Cost %</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-600">Industry Average:</span>
        ...
        <div className="mt-16 bg-gradient-to-r from-primary to-blue-600 rounded-2xl p-8 text-white text-center">
          ...
          <p className="text-lg text-blue-100 mb-8 max-w-3xl mx-auto">
            Join thousands of businesses already saving with AI-powered workforce optimization. 
          ...
          <div className="grid md:grid-cols-4 gap-6 mt-8 pt-8 border-t border-white border-opacity-20">
            ...
            <div className="text-center">
              ...
              <div className="text-blue-200 text-sm">Guaranteed Savings</div>
            </div>
            <div className="text-center">
